package com.dht.editimage.editimage.adapter;
...
public class StickerTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    public static final int[] typeIcon = {R.mipmap.stickers_type_animal,
            R.mipmap.stickers_type_motion, R.mipmap.stickers_type_cos,
            R.mipmap.stickers_type_mark, R.mipmap.stickers_type_decoration};
