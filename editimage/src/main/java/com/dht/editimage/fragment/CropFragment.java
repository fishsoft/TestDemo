...
import com.dht.editimage.editimage.model.RatioItem;
import com.dht.editimage.editimage.util.Matrix3;
...
public class CropFragment extends Fragment {
    ...
    private final class CropImageTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ImageBaseAcitvity.getLoadingDialog(getActivity(), R.string.saving_image,
                    false);
            dialog.show();
        }
