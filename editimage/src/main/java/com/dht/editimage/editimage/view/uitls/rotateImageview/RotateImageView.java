package com.dht.editimage.editimage.view.uitls.rotateImageview;
...
import com.dht.editimage.editimage.util.PaintUtil;
...
public class RotateImageView extends View {
    ...
    public void addBit(Bitmap bit, RectF imageRect) {
        ...
        if(null==bit) throw new NullPointerException("亲，你还没有选择图片哦");
